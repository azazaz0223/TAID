...
@section('container')
    ...
    <div class="container-fluid p-3 m-1">
        ...
        <div class="card col-12 rounded-3 bg-white mb-4">
            <h2 class="fs-5 p-3 fw-bold border-bottom">課程資訊列表</h2>
        ...
        <div class="card col-12 rounded-3 bg-white mb-4">
            <h2 class="fs-5 p-3 fw-bold border-bottom">課程資訊</h2>
            ...
            <form id="create">
                ...
                <div class="card-body border-bottom d-flex justify-content-between gap-3">
                    ...
                    <div class="col-8 card-body fs-6 gray_l rounded-3">
                        <label class="mb-2">預覽課程內容圖</label>
                        <div class="p-0">
    ...
    <script>
        ...
        function createBtn() {
            ...
            $.ajax({
                url: "{{ route('backend.course.create') }}",
                type: "POST",
                headers: {
